 ...
 * `published-exercise-dictionary-cache.ts`) so multiple composers do not re-fetch the catalog.
 * Legacy path — migrate to RLS `useExerciseDictionaryAutocomplete` in a follow-up.
 */
export function usePublishedExerciseDictionary() {
