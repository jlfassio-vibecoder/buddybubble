...
import { validateTabataCircuitCardinality } from './interval-circuit-cardinality';
...
} from '../_shared/workout-metadata/structural-patch-types';
import {
  asProposedWorkoutMetadataView,
  type ProposedWorkoutMetadataView,
} from './proposed-workout-metadata-view';
