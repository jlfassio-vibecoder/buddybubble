/**
 * Server-side workout cue merge into `tasks.metadata` (M3/M5). Mirrors client
 * `applyCuePatchesToMetadata` for flat cache + factory Exercise cue SoT.
 * Deno mirror: `supabase/functions/agents/coach/workout-cue-metadata-merge.ts`.
 */
