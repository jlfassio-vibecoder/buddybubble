/**
 * UI/DB view-model for Coach `proposed_workout_metadata` (creation / pre-rich path).
 * Decoupled from Vertex responseSchema bricks — React and draft cards import this type only.
 *
 * Deno mirror: `supabase/functions/agents/coach/proposed-workout-metadata-view.ts`.
