/**
 * Parametric workout block blueprints — closed-world formats for Coach structured output.
 *
 * Canonical source; byte-for-byte mirror at
 * `supabase/functions/agents/coach/block-blueprint-library.ts`.
 */
