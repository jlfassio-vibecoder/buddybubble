/**
 * Client `messages.metadata.exercise_mentions` + Coach prompt `TAGGED_EXERCISE_REFS` block.
 * Mirror: `supabase/functions/agents/coach/exercise-mentions.ts`. Run `pnpm check:agent-mirror`.
 */
