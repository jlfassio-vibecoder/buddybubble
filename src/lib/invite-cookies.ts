...
// TDD originally suggested ~15m; 24h reduces stranded invitees after slow email confirm/OAuth.
// Invite rows still enforce expires_at / max_uses in RPCs — this cookie is only a browser handoff.
