          ...
          <>
            <div
              className={cn(
                ...
                isMobileDrawerMode ? '-mx-2 border-b px-2 pb-2 pt-1' : 'p-3',
              )}
            >
              ...
              {canCreateWorkspaceBubble && (
                <form
                  onSubmit={addBubble}
                  className={cn('mt-2', isMobileDrawerMode ? 'flex flex-col gap-2' : 'flex gap-2')}
                >
                  <Input
                  ...
                  <Button
                    ...
                    className={isMobileDrawerMode ? 'w-full' : undefined}
                  >
                    Add
                  </Button>
                </form>
              ...
              {isAdmin ? (
                <div
                  className={cn(
                    'mt-2 flex w-full gap-0.5 rounded-md border border-sidebar-border bg-sidebar-accent/30',
                    isMobileDrawerMode ? 'h-8 p-0.5' : 'h-9 p-0.5',
                  )}
                  role="group"
                ...
                >
                  <button
                    ...
                    className={cn(
                      'flex min-w-0 flex-1 items-center justify-center gap-1 rounded-sm px-1 font-medium transition-colors',
                      isMobileDrawerMode ? 'text-[10px]' : 'gap-1.5 px-1.5 text-xs',
                      activeTab === 'main'
            ...
            <ScrollArea className="min-h-0 flex-1 overflow-hidden">
              ...
              <ul className={cn(isMobileDrawerMode ? 'px-1.5 py-2' : 'p-2')}>
                {(!isAdmin || activeTab === 'main') && (
                  <li key={ALL_BUBBLES_BUBBLE_ID}>
                    <button
                      ...
                      className={cn(
                        'mb-1 flex w-full items-center gap-2 rounded-md px-2 text-left text-sm font-medium transition-colors',
                        isMobileDrawerMode ? 'py-1.5' : 'py-2',
                    ...
                    <li key={b.id} className="group relative mb-1">
                      ...
                      {isAdmin ? (
                        <button
                          ...
                          className={cn(
                            'absolute right-1 top-1/2 z-20 -translate-y-1/2 rounded',
                            isMobileDrawerMode
                              ? 'flex min-h-11 min-w-11 items-center justify-center p-2 opacity-100'
                              : 'p-1 opacity-0 transition-opacity group-hover:opacity-100 focus-visible:opacity-100',
                            selectedBubbleId === b.id
