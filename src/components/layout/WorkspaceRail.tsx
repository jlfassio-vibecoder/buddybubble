...
export function WorkspaceRail({ onOpenProfile, profileAvatarUrl, profileName }: Props) {
  ...
  return (
    <>
      <aside
        className="flex w-[72px] shrink-0 flex-col border-r border-zinc-800 bg-zinc-950 py-2"
          ...
          {onOpenProfile && (
            ...
            >
              {profileAvatarUrl ? (
                ...
                <span className="text-[11px] font-semibold text-zinc-300">{profileInitial}</span>
              )}
            </button>
          )}
        </div>
