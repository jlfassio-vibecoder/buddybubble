  ...
  return (
    <Sheet open={open} onOpenChange={onOpenChange}>
      <SheetContent side="left" className="w-[min(100vw-0.5rem,24rem)] max-w-none p-0">
        <SheetTitle className="sr-only">Socialspaces and channels</SheetTitle>
        <div className="flex h-full min-h-0 w-full flex-col overflow-hidden pt-[max(3rem,env(safe-area-inset-top,0px))] pb-[env(safe-area-inset-bottom,0px)]">
          {children}
        </div>
      </SheetContent>
    </Sheet>
