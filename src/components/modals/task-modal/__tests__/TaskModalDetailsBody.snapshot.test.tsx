...
const baseProps: TaskModalDetailsBodyProps = {
  ...
  eventEnds: '',
  onEventEndsChange: noop,
  eventGoingCount: 0,
  eventRsvpPeople: [],
  eventIsGoing: false,
  onToggleEventGoing: noop,
  eventGoingBusy: false,
  eventGoingDisabled: true,
  eventRsvpLoading: false,
  experienceSeason: '',
  ...
  programSchedule: [],
  onProgramScheduleChange: noop,
  programCapacity: '',
  onProgramCapacityChange: noop,
  programEnrolledCount: 0,
  programEnrollPeople: [],
  programIsEnrolled: false,
  onToggleProgramEnroll: noop,
  programEnrollBusy: false,
  programEnrollDisabled: true,
  programEnrollLoading: false,
  programLinkedWorkouts: [],
  onOpenLinkedTask: noop,
