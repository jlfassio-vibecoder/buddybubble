...
export function ChatArea({
  ...
  const currentTab = normalizeMobileTab(searchParams.get('tab'));
  ...
  }, [isNarrow, currentTab, clearThreadFromUrlReplace]);
  ...
  return (
    ...
    >
      ...
      {activeBubble?.name === 'Classes' &&
      workspaceId &&
      activeBubble.workspace_id === workspaceId ? (
        <ActiveClassBanner workspaceId={workspaceId} />
      ) : null}
