-- Persist Coach `task_modal_intake_patch` on agent reply metadata (task modal workout intake wizard).
-- Extends `agent_create_card_and_reply` and `agent_insert_coach_workout_draft_reply`.
