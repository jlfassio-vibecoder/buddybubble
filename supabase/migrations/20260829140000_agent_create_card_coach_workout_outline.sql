-- Phase 2 Apex Architect: seed tasks.metadata.coach_workout_outline at card creation.
...
comment on function public.agent_create_card_and_reply(
  ...
  'Agent reply with optional Kanban task; optional p_execution_patch, p_personal_cues, p_task_modal_intake_patch, p_card_action, and p_coach_workout_outline; seeds tasks.metadata.coach_workout_outline at INSERT when outline array non-empty; service_role only.';
