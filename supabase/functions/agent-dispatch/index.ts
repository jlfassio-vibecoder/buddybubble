/**
 * Supabase Edge Function: consolidated agent dispatcher (Phase 2).
 *
 * This is the new parallel entry point. The legacy dispatchers (`bubble-agent-dispatch`,
 * `buddy-agent-dispatch`, `organizer-agent-dispatch`) continue to receive production
 * webhooks; this function exists alongside them so Phase 3 can flip Coach's webhook
 * over with zero touches to the live functions.
 *
