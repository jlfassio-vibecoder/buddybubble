/**
 * MIRROR FILE — canonical lives at `src/lib/agents/organizer/prompts.ts`.
 *
 ...
 * this module. The legacy Deno file at
 * `supabase/functions/organizer-agent-dispatch/organizerPrompt.ts` re-exports
 * `organizerSystemPrompt` from this file (cross-function imports under
 * `supabase/functions/` are supported by the Edge Functions bundler) so the legacy
 * dispatcher can keep using its existing import path until Phase 6 deletes it.
 */
