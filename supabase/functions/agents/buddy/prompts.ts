/**
 * MIRROR FILE — canonical lives at `src/lib/agents/buddy/prompts.ts`.
 *
 ...
 * `supabase/functions/buddy-agent-dispatch/buddyPrompt.ts` re-exports
 * `buddySystemPrompt` from this file (cross-function imports under
