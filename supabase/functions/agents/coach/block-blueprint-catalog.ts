/** MIRROR FILE — canonical lives at `src/lib/agents/coach/block-blueprint-catalog.ts`.
 *
...
import { BLOCK_FORMAT_ENUM, REQUIRED_FORMAT_PARAMS_BY_FORMAT } from './block-blueprint-library.ts';
