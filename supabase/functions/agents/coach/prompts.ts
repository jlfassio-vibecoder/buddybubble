...
export function buildOutlineCoPilotModeCoachBlock(): string {
  return (
    ...
    'Encourage catalog structural tokens in chat (e.g. :main/emom/alternating, :finisher/tabata) matching the BLOCK BLUEPRINT LIBRARY. ' +
