...
} from './class-recording-metadata.ts';
...
/** Mirror of `src/lib/agora/recording-reconcile.ts#canAdvancePipelineStatus`. */
...
/** Parity with `src/lib/agora/recording-reconcile.ts` — forward-only instance metadata pipeline UX. */
