 ...
 * Deno mirror of `src/lib/agents/_shared/workout-metadata/apply-structural-patch-to-task-metadata.ts`.
 */

import type { CoachStructuralPatchOp } from './structural-patch-types.ts';
import { blockMatchesStructuralId, exerciseMatchesStructuralId } from './structural-id-match.ts';
