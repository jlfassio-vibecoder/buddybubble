...
- **Tripwire logs:** original scaffold mandated `[DEBUG]` lifecycle strings; most were removed from production paths (May 2026). Token-route Tier C logs remain dev-gated. See `docs/live-video/readme.md` § Debug Logging.
