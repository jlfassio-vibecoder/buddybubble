...
**Implementation plans:** [parametric-step1-2-plan.md](./parametric-step1-2-plan.md) · [parametric-step3-plan.md](./parametric-step3-plan.md) · [parametric-step4-plan.md](./parametric-step4-plan.md) · [parametric-step5-plan.md](./parametric-step5-plan.md) · [parametric-step6-plan.md](./parametric-step6-plan.md) · [parametric-step7-plan.md](./parametric-step7-plan.md) · [parametric-step8-plan.md](./parametric-step8-plan.md) · [parametric-step9-plan.md](./parametric-step9-plan.md) · Native Alternating EMOMs: [parametric-emom-alternating-phase1-plan.md](./parametric-emom-alternating-phase1-plan.md) · [parametric-emom-alternating-phase2-plan.md](./parametric-emom-alternating-phase2-plan.md) · [parametric-emom-alternating-phase3-plan.md](./parametric-emom-alternating-phase3-plan.md) · **Active Session (side-by-side with WorkoutPlayer):** [active-session-engine-plan.md](../active-session-engine-plan.md)
...
| **Data (read path — execution)**    | **WorkoutPlayer** (default modal) and **Active Session** (opt-in route) via `useWorkoutSessionViewModel`: block list, subtitles, **Tabata/EMOM interval shells**, alternating **modulo highlight routing**. Active Session adds XState orchestration — see [active-session-engine-plan.md](../active-session-engine-plan.md). | Athletes see and **run** parametric intent, not only read it                                        |
...
**Bottom line:** The parametric engine is production-active in **WorkoutPlayer** (blocks, timers, alternating highlights) and **Active Session** (opt-in route, XState shell, same ViewModel). Remaining gaps are mostly **live-video flat loggers**, **block-aware editing** (Step 5), and advanced format UX (superset pairing, ladder progression UI).
...
| 4   | **WorkoutPlayer**          | [WorkoutPlayer.tsx](../../../src/components/fitness/WorkoutPlayer.tsx)                           | Live session (modal): blocks, **timers**, finish → `workout_log`  | `useWorkoutSessionViewModel` → `WorkoutPlayerBlockList`; flat logging indices                          |
| 4b  | **ActiveSessionShell**     | [ActiveSessionShell.tsx](../../../src/features/active-session/components/ActiveSessionShell.tsx) | Live session (route): same block list + XState persistence/finish | Same ViewModel; `NEXT_PUBLIC_ACTIVE_SESSION_ROUTE=1` opt-in                                            |
